/*
NHP Options Panel - http://leemason.github.io/NHP-Theme-Options-Framework/
License: Apache License v2.0
Copyright: Lee Mason, no-half-pixels.com
*/
jQuery(document).ready(function(){
	...
	if(jQuery('#nhp-opts-save').is(':visible')){
		jQuery('#nhp-opts-save').delay(4000).slideDown('slow');
	}
